...
Default power plan keys generated by `scripts/gen_system_hiv.py`:

```
\Registry\Machine\System\Power
  \ActivePlan = 0 (REG_DWORD)  — 0=Balanced, 1=Performance, 2=PowerSaver
  \Plans
    \Balanced
      \DisplayTimeout = 10 (REG_DWORD, minutes)
      \SleepTimeout = 30 (REG_DWORD, minutes)
      \HibernateEnabled = 1 (REG_DWORD, bool)
      \CpuPolicy = "Balanced" (REG_SZ)
      \LidAction = 1 (REG_DWORD: 0=Nothing, 1=Sleep, 2=Hibernate, 3=Shutdown)
      \PowerButtonAction = 3 (REG_DWORD)
    \Performance
      \DisplayTimeout = 30
      \SleepTimeout = 60
      \HibernateEnabled = 0
