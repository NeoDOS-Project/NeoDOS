...
ABI_TABLE_FIELDS = [
    ...
    ("sys_ob_set_info", "extern \"C\" fn(u8, u32, *const u8, usize) -> i64", "int64_t (*)(uint8_t, uint32_t, const uint8_t*, size_t)", 8),
    ("sys_ob_enum", "extern \"C\" fn(u8, *mut u8, usize) -> i64", "int64_t (*)(uint8_t, uint8_t*, size_t)", 8),
    ("sys_ob_wait", "extern \"C\" fn(u8) -> i64", "int64_t (*)(uint8_t)", 8),
...
SYSCALL_MAP = [
    ...
    ("dup2", 6, "sys_dup2"),
    ("spawn", 7, "sys_spawn"),
    ("readdir", 8, "sys_readdir"),
    ("waitpid", 9, "sys_waitpid"),
    ("open", 10, "sys_open"),
    ("close", 13, "sys_close"),
    ("chdir", 16, "sys_chdir"),
    ("chdir_parent", 47, "sys_chdir_parent"),
    ("brk", 18, "sys_brk"),
    ("mmap", 19, "sys_mmap"),
    ("munmap", 20, "sys_munmap"),
    ("loadlib", 21, "sys_loadlib"),
    ("thread_create", 22, "sys_thread_create"),
    ("thread_join", 23, "sys_thread_join"),
    ...
    ("poll", 59, "sys_poll"),
    ("ob_open", 60, "sys_ob_open"),
    ("ob_create", 61, "sys_ob_create"),
    ("ob_query_info", 62, "sys_ob_query_info"),
    ("ob_set_info", 63, "sys_ob_set_info"),
    ("ob_enum", 64, "sys_ob_enum"),
    ("ob_wait", 65, "sys_ob_wait"),
    ("ob_destroy", 66, "sys_ob_destroy"),
]
...
def analyze_libneodos_coverage() -> str:
    ...
    syscall_names = {
        ...
        5: "pipe", 6: "dup2", 7: "spawn", 8: "readdir",
        ...
        63: "ob_set_info", 64: "ob_enum", 65: "ob_wait", 66: "ob_destroy",
    }
    ...
    libneodos_syscalls = {
        ...
        4: "sys_read",
        5: "sys_pipe", 6: "sys_dup2", 7: "sys_spawn", 8: "sys_readdir",
        9: "sys_waitpid",
        10: "sys_open", 13: "sys_close",
        16: "sys_chdir", 47: "sys_chdir_parent",
        18: "sys_brk", 19: "sys_mmap", 20: "sys_munmap",
        21: "sys_loadlib",
        60: "sys_ob_open", 61: "sys_ob_create", 62: "sys_ob_query_info",
        63: "sys_ob_set_info", 64: "sys_ob_enum", 65: "sys_ob_wait",
    }
