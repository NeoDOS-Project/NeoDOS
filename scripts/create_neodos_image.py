...
''')
    ...
    if args.minimal:
        ...
        nem_data = {
            ...
            17: ("e1000.nem",    read_nem("SYSTEM", "e1000.nem")),
        ...
        label_blocks      = alloc_blocks(45, len(nxe_files['label']))
        ...
        image[offset+1792:offset+2048]= create_dir_entry(17, 1, "e1000.nem")
        ...
        image[offset+2816:offset+3072]= create_dir_entry(46, 1, "type.nxe")
